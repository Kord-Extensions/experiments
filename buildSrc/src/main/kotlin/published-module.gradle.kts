...
//                artifact(dokkaJar)
				...
				pom {
					...
					scm {
						connection.set("scm:git:https://github.com/Kord-Extensions/experiments.git")
						developerConnection.set("scm:git:git@github.com:Kord-Extensions/experiments.git")
						url.set("https://github.com/Kord-Extensions/experiments.git")
					}
